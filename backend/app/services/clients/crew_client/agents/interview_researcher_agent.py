...
class InterviewReseacher():
    ...
    def reporting_task(self) -> Task:
        return Task(
            description=tasks_config['interview_prep_references_task']['description'],
            expected_output=tasks_config['interview_prep_references_task']['expected_output'],
            agent=self.interview_preparation_researcher(),
        )
    @crew
    def crew(self) -> Crew:
